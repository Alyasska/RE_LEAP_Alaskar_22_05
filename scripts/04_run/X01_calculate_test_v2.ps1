...
$dataFile   = Join-Path $projectRoot "data\audit_reports\calctest_v2_idx${AreaIndex}_${timestamp}.data.txt"
$reportPath = Join-Path $projectRoot "data\audit_reports\calctest_v2_idx${AreaIndex}_${timestamp}.md"
$runLogPath = Join-Path $projectRoot "logs\X01v2_idx${AreaIndex}_${timestamp}.log"
